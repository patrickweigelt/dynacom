...
### c) Non-metric Multidimensional Scaling (NMDS)
...
# make subset for one region

betadiv <- vegdist(specsbysites_ab_PCA, method="bray")  # 1- abundance based Sörensen Index
betadiv_step <- stepacross(betadiv, "extended")
...
nmds <- metaMDS(betadiv_step, k=3)
stressplot(nmds, betadiv)
plot(nmds)
